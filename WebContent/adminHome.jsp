...
<img src="rcpitlogo.jpeg"  align="left"width="100" height="100">
<center><h1 width="100" height="100">R C Patel Institute of Technology</h1>
</center>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      %>
        ...
        <tr> 
          ...
          <td><a href="delete.jsp?Roll_No=<%=rs.getString(3) %>">delete</a><%%></td>
        </tr>
      </tbody>
      <%}}
      catch(Exception e)
...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact KundanRPatil.
Designed & Developed by KundanRPatil</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ KundanRPatil</h5></center> 
  <hr class="new1">
<br>
</body>
</html>